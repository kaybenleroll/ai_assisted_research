# SILO RPG DOCUMENT INDEX

This file serves as a routing map for LLMs and GMs to quickly locate specific lore, mechanics, and rules across the Silo RPG document suite without reading all files into context.

## 1. PLAYER INTRODUCTION
**File:** `gaming_silo_player_guide.md`
**Purpose:** Session Zero handout. Visceral tone, citizen perspective, biased world-view. Contains no GM secrets.
**Contents:**
*   **The Three Absolute Truths:** The Outside is Death, The Pact is Law, The Cleaning is Our Burden.
*   **Sector Vibes (Biased):** Up Top (Elite/Surveillance), Mids (Grind/Farms), Down Deep (Grease/Noise).
*   **Character Archetypes:** Brief descriptions of Porters, Mechanics, Supply Clerks, Hydroponics Farmers, IT Techs.
*   **The Friends of the Silo:** Player-facing warning about the secret police.
*   **Default Citizen Knowledge:** Travel realities, stamped-paper culture, and what every survivor learns by osmosis.
*   **Session Zero Questions & Slang:** Prompts for party creation and a quick glossary of common Silo terms.
...
*   **Chapter 31: Core Play Procedure**
    *   System-agnostic pressure tracks, fail-forward consequences, escalation clocks, and downtime actions.
*   **Chapter 32: Faction Sheets**
    *   Public face, real objectives, leverage, and typical asks for the major factions.
*   **Chapter 33: Slice-of-Life Engine**
    *   Random generators for block problems, inspections, favors, and sudden shortages.
...
## 4. GAME MASTER'S SECRETS & MACRO-LORE
**File:** `gaming_silo_gm_secrets.md`
**Purpose:** The overarching truth of the setting, based on the *Wool/Shift/Dust* novels. Strictly for endgame GM use.
**Contents:**
*   **Part 1: The True Reality:** Operation Fifty (the grid of 50 silos), Silo 1 (cryo-pods and control), the Nanobot Dome (why outside is deadly), the truth about the Argon gas and heat-tape during a Cleaning.
*   **Part 2: The Lies Within:** IT's secret comms room to Silo 1, the hidden IT elevator, amnesiac drugs in the water supply, the massive Digger parked beneath Level 144.
*   **Part 3: Campaign Pacing Guide:** A 4-phase guide on how to keep the campaign focused on daily survival before introducing the macro-lore.
