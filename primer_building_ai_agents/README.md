...
| File | Purpose |
|---|---|
| [`primer_ai_agents_comprehensive.md`](primer_ai_agents_comprehensive.md) | **Start here.** Accessible end-to-end primer: fundamentals, execution loops, tools, memory, patterns, challenges, and how to build your first agent |
| [`primer_agent_quick_reference.md`](primer_agent_quick_reference.md) | Developer cheat sheet: pattern selection matrices, code snippets, framework comparison, error handling strategies |
...
The canonical source file, [`primer_ai_agents_comprehensive.md`](primer_ai_agents_comprehensive.md), is intentionally kept renderable to both HTML and PDF from the same markdown content.
...
```
primer_building_ai_agents/
├── primer_ai_agents_comprehensive.md   # Main primer document
├── primer_agent_quick_reference.md            # Developer cheat sheet
...
### Document 2: `primer_agent_quick_reference.md`
