...
- `workbook_elt.qmd`: canonical primer document
- `workbook_quickstart.qmd`: fast-start operational guide
- `workbook_executable_index.qmd`: runnable script and target map
